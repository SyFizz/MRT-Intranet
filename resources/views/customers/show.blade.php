<x-app-layout>
    ...
    <div class="pt-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex">
            <div class="rounded overflow-hidden shadow-lg bg-white m-5 w-full">
                <div class="px-6 py-4">
                    <div class="font-bold text-2xl mb-2 underline text-center">Informations du client</div>
                ...
                <div class="px-6 pt-4 pb-2 justify-center align-middle justify-items-center text-center">
                    @foreach($customer->invoices as $invoice)
                        <a href='{{ route('invoice.show', ['id' => $invoice->id]) }}'
                           class="inline-block bg-blue-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 w-1/2">{{ $invoice->filename }} - {{ $invoice->created_at->format('d/m/Y à H:i') }}
                        </a>
                        <br>
                    @endforeach
